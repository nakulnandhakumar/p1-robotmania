...
<p>TO-DO:<br />- Make a two-player mode for Battleship<br />- Create a safe exit function to close Battleship when finished and return to main menu<br />- Improve GUI with icons.
